...
!            1.dims and input variables from namelist
...
!            Converted to F90, creating allocation and 1 main
!            subroutines.
!
!  2000/07/28 (Ming Xue)
...
!
!  REAL :: obsng  (nvar_anx_ADAS,mx_sng)
!  REAL :: odifsng(nvar_anx_ADAS,mx_sng)
!  REAL :: oanxsng(nvar_anx_ADAS,mx_sng)
!#ifdef arps3dvar
...
!-----------------------------------------------------------------------
!
!  REAL :: obsua (nvar_anx_ADAS,nz_ua,mx_ua)
!  REAL :: odifua(nvar_anx_ADAS,nz_ua,mx_ua)
!  REAL :: oanxua(nvar_anx_ADAS,nz_ua,mx_ua)
!#ifdef arps3dvar
...
!
!  REAL :: odifrad(nvar_rad_ADAS,nz_rdr,mx_colrad)
!  REAL :: oanxrad(nvar_rad_ADAS,nz_rdr,mx_colrad)
!#ifdef arps3dvar
...
!
  ...
  REAL :: obsret (nvar_anx_ADAS,nz_ret,mx_colret)
  REAL :: odifret(nvar_anx_ADAS,nz_ret,mx_colret)
  REAL :: oanxret(nvar_anx_ADAS,nz_ret,mx_colret)
...
!
  ...
  REAL :: qback  (nvar_anx_ADAS,nz_tab)
  REAL :: qsrcsng(nvar_anx_ADAS,nsrc_sng)
  REAL :: qsrcua (nvar_anx_ADAS,nz_tab,nsrc_ua)
  REAL :: qsrcret(nvar_anx_ADAS,nz_tab,nsrc_ret)
!
!-----------------------------------------------------------------------
!
...
!  INTEGER :: qualsng(nvar_anx_ADAS,mx_sng)
!  REAL    :: qobsng(nvar_anx_ADAS,mx_sng)
  REAL    :: qcthrsng(nvar_anx_ADAS,nsrc_sng)
  REAL    :: barqclim(nvar_anx_ADAS,nsrc_sng)

  REAL :: qcmulua(nsrc_ua)

!  INTEGER :: qualua(nvar_anx_ADAS,nz_ua,mx_ua)
!  REAL :: qobsua (nvar_anx_ADAS,nz_ua,mx_ua)
  REAL :: qcthrua(nvar_anx_ADAS,nsrc_ua)
!
  REAL :: qcmulrad(nsrc_rad)
  REAL :: qcthrrad(nvar_radin,nsrc_rad)
!  INTEGER :: qualrad(nvar_rad_ADAS,nz_rdr,mx_colrad)
!  REAL :: qobsrad(nvar_rad_ADAS,nz_rdr,mx_colrad)
!
  REAL :: qcmulret(nsrc_ret)
  INTEGER :: qualret(nvar_anx_ADAS,nz_ret,mx_colret)
  REAL :: qobsret(nvar_anx_ADAS,nz_ret,mx_colret)
  REAL :: qcthrret(nvar_anx_ADAS,nsrc_ret)
!
!-----------------------------------------------------------------------
!
...
!-----------------------------------------------------------------------
  ...
  nvar_anx = nvar_anx_ADAS
  nvar_rad = nvar_rad_ADAS

!-----------------------------------------------------------------------
!  Read in 1 namelist parameters
!-----------------------------------------------------------------------
!
...
!!
!!!!!!!!!!!!!!!!!!!!!! This is a branch for 1 analysis !!!!!!!!!!!!!!
!!
