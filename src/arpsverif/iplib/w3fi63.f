...
C   96-07-01  R.E.JONES   ADDED GRID 218, 10 KM ETA AWIPS OLYMPIC GRID 
C   96-08-19  R.E.JONES   ADDED MERCATOR GRIDS 8 AND 53, AND GRID 196
C   96-12-04  R.E.JONES   REFNCE IS SPELLED AS REFNC IN DO LOOP 4001.
C                         REFNC IS SET TO 0 CAUSING GRIB GRIDS
C                         23,24,26,63,64 TO HAVE ALL POSITIVE VALUES.
C
          ...
          IF (IAND(KPDS(4),64).NE.0) THEN
              IF (KPDS(3).NE.255) THEN
                  ...
                  IF (KPDS(1).EQ.7) THEN
                      ...
                      ELSE IF (KPDS(3).GE.201.AND.KPDS(3).LE.218) THEN
                      ELSE
...
C             SiliconGraphics 3.4 FORTRAN 77
C             March 1991, RUSSELL E. JONES
C             NATIONAL WEATHER SERVICE
C             CHANGE AUG. 1992 REPLACE ISHFT WITH LSHIFT & RSHIFT
C             THIS MAKES IT FASTER, BUT NOT PORTABLE.
C             SGI VERSION ONLY.
C
...
C
      IF (MOVER.GT.0) THEN
        IOUT  = IAND(RSHIFT(IN(INDEX+1),MOVER),MASK)
C
...
C             MAY 1972
C
C             CHANGES FOR SiliconGraphics IRIS-4D/25, 35, INDIGO
C             SiliconGraphics 3.5 FORTRAN 77
C             MARCH 1991, RUSSELL E. JONES
C             NATIONAL WEATHER SERVICE
C             CHANGE AUG. 1992 REPLACE ISHFT WITH LSHIFT & RSHIFT
C             THIS MAKES IT FASTER, BUT NOT PORTABLE.
...
C             NATIONAL WEATHER SERVI 
C             JUNE 1990, RUSSELL E. JONES
C             NATIONAL WEATHER SERVICE
C             CHANGE AUG. 1992 REPLACE ISHFT WITH LSHIFT & RSHIFT
C             THIS MAKES IT FASTER, BUT NOT PORTABLE.
C             SGI VERSION ONLY.
