!
!  This file contains IBM AIX system specific routines
!  and functions.
!
!
!
...
! MODIFICATION HISTORY:
!
!   Converted from mova2i initially by
!
!   PRGMMR: Gilbert          ORG: W/NP11     DATE: 98-12-15                     
!                                                                               
! USAGE:     I = char2i(a)
!                                                                               
!   INPUT ARGUMENT :
...
!                                                                               
  ...
  char2i = ISHFT(TRANSFER(a,mold),8-BIT_SIZE(mold))
...
SUBROUTINE arpssighandle()
  ...
  WRITE (0,*) "ERROR: processor ",myproc," caught a signal."
  CALL arpsstop("arpsstop called from arpssighandle due to myproc",0)
